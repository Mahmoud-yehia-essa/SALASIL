...
<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('add.position.user.store') }}" method="POST">
                @csrf
                        ...
                        <select name="user_id" id="user_id" class="form-control" required>
                            ...
                            @foreach($users as $user)
                                <option
                                    ...
                                    data-phone="{{ $user->country_code }} {{ $user->phone }}"
                                >
                ...
                <div class="mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                                <input type="number" name="user_position" class="form-control" required>
                                @error('user_position') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                    </div>

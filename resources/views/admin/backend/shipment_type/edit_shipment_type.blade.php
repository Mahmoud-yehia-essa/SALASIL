...
<div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center mb-4 pb-2 border-bottom border-secondary border-opacity-25 gap-3">
    <div>
        <h3 class="fw-bold mb-1 header-title">
            <i class="bx bx-edit-alt text-info me-2"></i>Edit Shipment Type
        </h3>
        <p class="text-slate-400 mb-0" style="font-size: 0.95rem;">
            Update shipment type names or active status.
        </p>
    </div>
    <div>
        ...
        <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
            <div class="card-header bg-transparent border-bottom border-secondary border-opacity-25 py-3 px-4">
                <h5 class="card-title mb-0 fw-bold d-flex align-items-center gap-2">
                    ...
                    <span>Edit Shipment Type #{{ $shipmentType->id }}</span>
                </h5>
            </div>

            <div class="card-body p-4">
                <form method="POST" action="{{ route('update.shipment.type') }}" id="editShipmentTypeForm">
                    @csrf
                    <input type="hidden" name="id" value="{{ $shipmentType->id }}">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="position-relative">
                                <input type="text" 
                                       ...
                                       value="{{ old('name_en', $shipmentType->name_en) }}"
                                       required>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="position-relative">
                                <input type="text" 
                                       ...
                                       value="{{ old('name_ar', $shipmentType->name_ar) }}"
                                       required>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <select name="is_active" id="is_active" class="form-select">
                                <option value="1" {{ old('is_active', $shipmentType->is_active) == 1 ? 'selected' : '' }}>Active (مفعل)</option>
                                <option value="0" {{ old('is_active', $shipmentType->is_active) == 0 ? 'selected' : '' }}>Inactive (غير مفعل)</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-3 mt-4 pt-3 border-top border-secondary border-opacity-25">
                        ...
                        <button type="submit" class="btn btn-primary px-5 py-2 rounded-3 fw-semibold d-inline-flex align-items-center gap-2">
                            ...
                            <span>Update Shipment Type</span>
                        </button>
                    </div>

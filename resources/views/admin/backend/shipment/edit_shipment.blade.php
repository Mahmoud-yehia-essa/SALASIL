...
/* ═════════════════════════════════════════════════════════════
   LIGHT MODE OVERRIDES FOR EDIT SHIPMENT 8-STEP WIZARD
═════════════════════════════════════════════════════════════ */
...
<div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center mb-4 pb-2 border-bottom border-secondary border-opacity-25 gap-3">
    <div>
        <h3 class="fw-bold mb-1 header-title">
            <i class="bx bx-edit text-info me-2"></i>Edit Shipment Order #{{ $shipment->id }}
        </h3>
        <p class="text-slate-400 mb-0" style="font-size: 0.95rem;">
            Update shipment order specifications and location details.
        </p>
    </div>
    <div>
        <a href="{{ route('all.shipments') }}" class="btn btn-outline-info rounded-3 px-3 py-2 fw-semibold d-inline-flex align-items-center gap-2">
...
{{-- Main Form --}}
<form method="POST" action="{{ route('update.shipment') }}" id="wizardForm" autocomplete="off">
    @csrf
    ...
    <div class="wz-card">
        ...
        <div class="wz-step-panel active" id="step1">
            <div class="wz-card-header">
                ...
                <div>
                    ...
                    <p>Select or update the customer assigned to this shipment.</p>
                </div>
            ...
            <div class="wz-card-body">
                ...
                <input type="hidden" name="customer_id" id="selectedCustomerId" value="{{ $shipment->customer_id }}">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-12">
                        ...
                        <div class="customer-list-container" id="customerList">
                            ...
                            <div class="customer-list-item {{ $shipment->customer_id == $customer->id ? 'selected' : '' }}"
                                 data-id="{{ $customer->id }}"
                ...
                <div id="customerInfoPanel" class="visible">
        ...
        <div class="wz-step-panel" id="step2">
            <div class="wz-card-header">
                ...
                <div>
                    ...
                    <p>Edit cargo information, dimensions, and classification.</p>
                </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="position-relative">
                            <input type="text" name="shipment_name" id="shipment_name" class="form-control input-icon-pad" style="padding-left:44px !important;" placeholder="e.g. Electronics Batch #001" value="{{ $shipment->shipment_name }}">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <select name="shipment_type_id" id="shipment_type_id" class="form-select">
                            ...
                            @foreach($shipmentTypes as $type)
                                <option value="{{ $type->id }}" {{ $shipment->shipment_type_id == $type->id ? 'selected' : '' }}>{{ $type->name_en ?? $type->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="shipment_description" id="shipment_description" class="form-control" rows="3" placeholder="Brief description of this shipment...">{{ $shipment->shipment_description }}</textarea>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <select name="shipment_nature_id" id="shipment_nature_id" class="form-select">
                            ...
                            @foreach($shipmentNatures as $nature)
                                <option value="{{ $nature->id }}" {{ $shipment->shipment_nature_id == $nature->id ? 'selected' : '' }}>{{ $nature->name_en ?? $nature->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <div class="position-relative">
                            <input type="number" name="weight" id="weight" class="form-control input-icon-pad" style="padding-left:44px !important;" placeholder="0.00" step="0.01" min="0" value="{{ $shipment->weight }}">
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <div class="position-relative">
                            <input type="number" name="packages_count" id="packages_count" class="form-control input-icon-pad" style="padding-left:44px !important;" placeholder="1" min="1" value="{{ $shipment->packages_count ?? 1 }}">
                        ...
                        <div class="row g-3">
                            <div class="col-4">
                                <div class="dimension-wrap">
                                    <input type="number" name="length" id="length" class="form-control pe-5" placeholder="Length" min="0" step="0.1" value="{{ $shipment->length }}">
                                    <span class="dim-label">L</span>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="dimension-wrap">
                                    <input type="number" name="width" id="width" class="form-control pe-5" placeholder="Width" min="0" step="0.1" value="{{ $shipment->width }}">
                                    <span class="dim-label">W</span>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="dimension-wrap">
                                    <input type="number" name="height" id="height" class="form-control pe-5" placeholder="Height" min="0" step="0.1" value="{{ $shipment->height }}">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="goods_description" id="goods_description" class="form-control" rows="3" placeholder="Special handling instructions, fragile items, notes...">{{ $shipment->goods_description }}</textarea>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="p-3.5 rounded-3 border hs-code-wrap" style="background: rgba(78, 205, 196, 0.05); border-color: rgba(78, 205, 196, 0.25) !important;">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input type="text" name="hs_code" id="hs_code" class="form-control text-white fw-bold" placeholder="Enter HS Code (e.g. 8704.21 or 8471.30)" value="{{ old('hs_code', $shipment->hs_code) }}">
                            ...
                            <input type="hidden" name="hs_code_description" id="hs_code_description_input" value="{{ old('hs_code_description', $shipment->hs_code_description) }}">
                        </div>
                    </div>
                </div>
        ...
        <div class="wz-step-panel" id="step3">
            <div class="wz-card-header">
                ...
                <div>
                    <h4>Truck Type</h4>
                    <p>Choose or update the truck type required.</p>
                </div>
                <div class="ms-auto"><span class="step-counter">Step 3 of 8</span></div>
            </div>
            <div class="wz-card-body">

                <input type="hidden" name="truck_type_id" id="truck_type_id" value="{{ $shipment->truck_type_id }}">
                <input type="hidden" name="truck_sub_type_id" id="truck_sub_type_id" value="{{ $shipment->truck_sub_type_id }}">
                ...
                <div class="row g-3" id="truckTypeGrid">
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="truck-type-card {{ $shipment->truck_type_id == $tt->id ? 'selected' : '' }}" data-id="{{ $tt->id }}" data-name="{{ $tt->name_en ?? $tt->name }}" onclick="selectTruckType(this)">
                ...
                {{-- Sub-types section --}}
                <div id="subTypeContainer" class="mt-4 {{ $shipment->truck_type_id ? 'visible' : '' }}">
                    ...
                    <select name="_truck_sub_type_select" id="truckSubTypeSelect" class="form-select" style="max-width:360px;">
                        ...
                        @foreach($truckSubTypes as $st)
                            <option value="{{ $st->id }}" {{ $shipment->truck_sub_type_id == $st->id ? 'selected' : '' }}>{{ $st->name_en }}</option>
                        @endforeach
                    </select>
                </div>
        ...
        <div class="wz-step-panel" id="step4">
            <div class="wz-card-header">
                ...
                <div>
                    ...
                    <p>Specify or update pickup location details.</p>
                </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <select name="pickup_country_id" id="pickup_country_id" class="form-select">
                            ...
                            @foreach($countries as $country)
                                <option value="{{ $country->id }}" {{ $shipment->pickup_country_id == $country->id ? 'selected' : '' }}>{{ $country->name_en }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-12 col-md-6">
                        ...
                        <select name="pickup_city_id" id="pickup_city_id" class="form-select" {{ $shipment->pickup_country_id ? '' : 'disabled' }}>
                            <option value="">-- Select City --</option>
                            @foreach($pickupCities as $city)
                                <option value="{{ $city->id }}" {{ $shipment->pickup_city_id == $city->id ? 'selected' : '' }}>{{ $city->name_en }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-12 col-md-6">
                        <label class="form-label">Area</label>
                        <input type="text" name="pickup_area" id="pickup_area" class="form-control" placeholder="e.g. Industrial Area, Zone 3" value="{{ $shipment->pickup_area }}">
                    </div>
                    <div class="col-12 col-md-6">
                        <label class="form-label">Full Address <span class="text-danger">*</span></label>
                        <input type="text" name="pickup_address" id="pickup_address" class="form-control" placeholder="e.g. King Fahd Road, Building 12" value="{{ $shipment->pickup_address }}">
                    </div>
                    <div class="col-12">
                        ...
                        <div class="map-container position-relative" id="pickupMapWrap">
                            ...
                            <div class="map-coords-badge" id="pickupCoordsLabel">
                                <i class="bx bx-crosshair me-1"></i>
                                {{ $shipment->pickup_lat ? number_format($shipment->pickup_lat, 5) . ' , ' . number_format($shipment->pickup_lng, 5) : 'Click map to set coordinates' }}
                            </div>
                        </div>
                        <input type="hidden" name="pickup_lat" id="pickup_lat" value="{{ $shipment->pickup_lat }}">
                        <input type="hidden" name="pickup_lng" id="pickup_lng" value="{{ $shipment->pickup_lng }}">
                    </div>
                </div>
        ...
        <div class="wz-step-panel" id="step5">
            <div class="wz-card-header">
                ...
                <div>
                    ...
                    <p>Specify or update delivery location details.</p>
                </div>
                ...
                <div class="row g-4">
                    <div class="col-12 col-md-6">
                        ...
                        <select name="dropoff_country_id" id="dropoff_country_id" class="form-select">
                            <option value="">-- Select Country --</option>
                            @foreach($countries as $country)
                                <option value="{{ $country->id }}" {{ $shipment->dropoff_country_id == $country->id ? 'selected' : '' }}>{{ $country->name_en }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-12 col-md-6">
                        ...
                        <select name="dropoff_city_id" id="dropoff_city_id" class="form-select" {{ $shipment->dropoff_country_id ? '' : 'disabled' }}>
                            <option value="">-- Select City --</option>
                            @foreach($dropoffCities as $city)
                                <option value="{{ $city->id }}" {{ $shipment->dropoff_city_id == $city->id ? 'selected' : '' }}>{{ $city->name_en }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-12 col-md-6">
                        <label class="form-label">Area</label>
                        <input type="text" name="dropoff_area" id="dropoff_area" class="form-control" placeholder="e.g. Downtown, Block A" value="{{ $shipment->dropoff_area }}">
                    </div>
                    <div class="col-12 col-md-6">
                        <label class="form-label">Full Address <span class="text-danger">*</span></label>
                        <input type="text" name="dropoff_address" id="dropoff_address" class="form-control" placeholder="e.g. Prince Sultan Street, Villa 5" value="{{ $shipment->dropoff_address }}">
                    </div>
                    <div class="col-12">
                        <label class="form-label d-flex align-items-center gap-2">
                        ...
                        <div class="map-container position-relative" id="dropoffMapWrap">
                            ...
                            <div class="map-coords-badge" id="dropoffCoordsLabel">
                                <i class="bx bx-crosshair me-1"></i>
                                {{ $shipment->dropoff_lat ? number_format($shipment->dropoff_lat, 5) . ' , ' . number_format($shipment->dropoff_lng, 5) : 'Click map to set coordinates' }}
                            </div>
                        </div>
                        <input type="hidden" name="dropoff_lat" id="dropoff_lat" value="{{ $shipment->dropoff_lat }}">
                        <input type="hidden" name="dropoff_lng" id="dropoff_lng" value="{{ $shipment->dropoff_lng }}">
                    </div>
                </div>
        ...
        <div class="wz-step-panel" id="step6">
            <div class="wz-card-header">
                ...
                <div>
                    ...
                    <p>Enter contact details for loading and receiving parties.</p>
                </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="contact-section-card loading">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="position-relative">
                                    <input type="text" name="loading_contact_name" id="loading_contact_name" class="form-control input-icon-pad" style="padding-left:44px !important;" placeholder="e.g. Mohammed Saeed" value="{{ $shipment->loading_contact_name }}">
                            ...
                            <div>
                                ...
                                <div class="position-relative">
                                    <input type="text" name="loading_contact_phone" id="loading_contact_phone" class="form-control input-icon-pad" style="padding-left:44px !important;" placeholder="e.g. +966501234567" value="{{ $shipment->loading_contact_phone }}">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="contact-section-card arrival">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Contact Name</label>
                                <div class="position-relative">
                                    <input type="text" name="arrival_contact_name" id="arrival_contact_name" class="form-control input-icon-pad" style="padding-left:44px !important;" placeholder="e.g. Khalid Al-Rashid" value="{{ $shipment->arrival_contact_name }}">
                            ...
                            <div>
                                <label class="form-label">Phone Number</label>
                                <div class="position-relative">
                                    <input type="text" name="arrival_contact_phone" id="arrival_contact_phone" class="form-control input-icon-pad" style="padding-left:44px !important;" placeholder="e.g. +966509876543" value="{{ $shipment->arrival_contact_phone }}">
        ...
        <div class="wz-step-panel" id="step7">
            <div class="wz-card-header">
                ...
                <div>
                    <h4>Pricing</h4>
                    <p>Update the estimated price for this shipment order.</p>
                </div>
            ...
            <div class="wz-card-body">
                ...
                <div class="pricing-card-glow">
                    ...
                    <div class="d-flex align-items-center justify-content-center gap-2">
                        ...
                        <input type="number" name="initial_price" id="initial_price" class="price-input" placeholder="0.00" step="0.01" min="0" value="{{ $shipment->initial_price }}">
                    </div>
                    <p class="text-muted mt-3" style="font-size:0.82rem;">Initial estimated price for this shipment.</p>
                </div>
        ...
        <div class="wz-step-panel" id="step8">
            <div class="wz-card-header">
                ...
                <div>
                    <h4>Order Review</h4>
                    <p>Review updated shipment details before saving changes.</p>
                </div>
            ...
            <div class="wz-card-body">
                ...
                <div class="text-center mt-4 pt-2">
                    <p class="text-muted" style="font-size:0.85rem;">Clicking update will save all changes to Shipment Order <strong class="text-info">#{{ $shipment->id }}</strong>.</p>
                </div>
...
<script>
    ...
    var pickupCenter  = { lat: {{ $shipment->pickup_lat ?: 24.7136 }}, lng: {{ $shipment->pickup_lng ?: 46.6753 }} };
    var dropoffCenter = { lat: {{ $shipment->dropoff_lat ?: 24.7136 }}, lng: {{ $shipment->dropoff_lng ?: 46.6753 }} };
    ...
    function initPickupMap() {
        ...
        pickupMap = new google.maps.Map(document.getElementById('pickupMap'), {
            center: pickupCenter,
            zoom: {{ $shipment->pickup_lat ? 14 : 11 }},
        ...
        @if($shipment->pickup_lat && $shipment->pickup_lng)
            setPickupCoords({{ $shipment->pickup_lat }}, {{ $shipment->pickup_lng }});
        @endif

        // Places Autocomplete
        var pickupInput = document.getElementById('pickupSearchInput');
        var pickupAuto  = new google.maps.places.Autocomplete(pickupInput, { fields: ['geometry', 'formatted_address', 'name'] });
        pickupAuto.bindTo('bounds', pickupMap);
        pickupAuto.addListener('place_changed', function() {
            var place = pickupAuto.getPlace();
            if (!place.geometry || !place.geometry.location) return;
            if (place.geometry.viewport) pickupMap.fitBounds(place.geometry.viewport);
            else { pickupMap.setCenter(place.geometry.location); pickupMap.setZoom(15); }
            setPickupCoords(place.geometry.location.lat(), place.geometry.location.lng());
            if (place.formatted_address) {
                var addrField = document.getElementById('pickup_address');
                if (addrField) addrField.value = place.formatted_address;
            }
        ...
        document.getElementById('pickupSearchClear').addEventListener('click', function() {
            ...
            document.getElementById('pickupCoordsLabel').innerHTML = '<i class="bx bx-crosshair me-1"></i>Click map to set coordinates';
    ...
    function initDropoffMap() {
        ...
        dropoffMap = new google.maps.Map(document.getElementById('dropoffMap'), {
            ...
            zoom: {{ $shipment->dropoff_lat ? 14 : 11 }},
            styles: getActiveMapStyles(),
            mapTypeControl: false,
            streetViewControl: false,
            fullscreenControl: true
        ...
        @if($shipment->dropoff_lat && $shipment->dropoff_lng)
            setDropoffCoords({{ $shipment->dropoff_lat }}, {{ $shipment->dropoff_lng }});
        @endif

        // Places Autocomplete
        var dropoffInput = document.getElementById('dropoffSearchInput');
        var dropoffAuto  = new google.maps.places.Autocomplete(dropoffInput, { fields: ['geometry', 'formatted_address', 'name'] });
        dropoffAuto.bindTo('bounds', dropoffMap);
        dropoffAuto.addListener('place_changed', function() {
            var place = dropoffAuto.getPlace();
            if (!place.geometry || !place.geometry.location) return;
            if (place.geometry.viewport) dropoffMap.fitBounds(place.geometry.viewport);
            else { dropoffMap.setCenter(place.geometry.location); dropoffMap.setZoom(15); }
            setDropoffCoords(place.geometry.location.lat(), place.geometry.location.lng());
            if (place.formatted_address) {
        ...
        document.getElementById('dropoffSearchClear').addEventListener('click', function() {
            ...
            document.getElementById('dropoffCoordsLabel').innerHTML = '<i class="bx bx-crosshair me-1"></i>Click map to set coordinates';
    ...
    function setPickupCoords(lat, lng) {
        ...
        document.getElementById('pickupCoordsLabel').innerHTML = '<i class="bx bx-map-pin me-1"></i>' + lat.toFixed(5) + ' , ' + lng.toFixed(5);
        if (pickupMarker) pickupMarker.setMap(null);
        pickupMarker = new google.maps.Marker({
            position: { lat: lat, lng: lng },
            map: pickupMap,
            animation: google.maps.Animation.DROP,
            icon: { path: google.maps.SymbolPath.CIRCLE, scale: 12, fillColor: '#06B6D4', fillOpacity: 1, strokeColor: '#ffffff', strokeWeight: 3 }
        });
    }
    ...
    function setDropoffCoords(lat, lng) {
        ...
        document.getElementById('dropoffCoordsLabel').innerHTML = '<i class="bx bx-map-pin me-1"></i>' + lat.toFixed(5) + ' , ' + lng.toFixed(5);
        if (dropoffMapMarker) dropoffMapMarker.setMap(null);
        dropoffMapMarker = new google.maps.Marker({
            position: { lat: lat, lng: lng },
            map: dropoffMap,
            animation: google.maps.Animation.DROP,
            icon: { path: google.maps.SymbolPath.CIRCLE, scale: 12, fillColor: '#10B981', fillOpacity: 1, strokeColor: '#ffffff', strokeWeight: 3 }
        });
    }
</script>
...
$(document).ready(function() {
    ...
    var initialCustomerId = $('#selectedCustomerId').val();
    ...
    function goToStep(step) {
        ...
        if (step === 5) {
            setTimeout(function() {
                if (mapsApiReady) initDropoffMap();
                else {
    ...
    $('[data-goto]').on('click', function() {
        ...
        if ($(this).hasClass('btn-wz-next') && !validateStep(currentStep)) return;
        goToStep(target);
    });
    ...
    function validateStep(step) {
        if (step === 1 && !$('#selectedCustomerId').val()) {
    ...
    function loadSubTypes(truckTypeId) {
        ...
        $.ajax({
            ...
            error: function() { $('#subTypeLoading').hide(); }
        });
    }
    ...
    $('#pickup_country_id').on('change', function() {
        ...
        $.ajax({
            ...
            error: function() { $('#pickupCityLoadingWrap').hide(); }
        });
    });
    ...
    $('#dropoff_country_id').on('change', function() {
        ...
        $.ajax({
            ...
            error: function() { $('#dropoffCityLoadingWrap').hide(); }
        });
    });
    ...
    function buildReview() {
        var html = '';
        var custName = $('.customer-list-item.selected').data('name') || 'Customer #' + $('#selectedCustomerId').val();
        var custEmail= $('.customer-list-item.selected').data('email') || '—';
        ...
        var typeName   = $('#shipment_type_id option:selected').text().trim();
        var natureName = $('#shipment_nature_id option:selected').text().trim();
        html += reviewSection('bx bx-package','Shipment Details', [
            ['Shipment Name', $('#shipment_name').val() || '—'],
            ['Description', $('#shipment_description').val() || '—'],
            ['Type', typeName || '—'],
            ['Nature', natureName || '—'],
            ['Dimensions', ($('#length').val()||'—') + ' × ' + ($('#width').val()||'—') + ' × ' + ($('#height').val()||'—') + ' cm'],
            ['Weight', ($('#weight').val() ? $('#weight').val() + ' kg' : '—')],
            ['No. of Pieces', $('#packages_count').val() || '1'],
        ]);

        var truckName = $('.truck-type-card.selected .truck-name').text().trim() || '—';
        var subName   = $('#truckSubTypeSelect option:selected').text().trim() || '—';
        if (subName === '-- Select Sub-Type --') subName = '—';
        html += reviewSection('bx bx-truck','Truck Type', [
            ['Truck Type', truckName],
            ['Sub-Type', subName],
        ]);

        var pCountry = $('#pickup_country_id option:selected').text().trim() || '—';
        var pCity    = $('#pickup_city_id option:selected').text().trim() || '—';
        html += reviewSection('bx bx-map-pin','Pickup Location', [
            ['Country / City', pCountry + ' / ' + pCity],
            ['Address', $('#pickup_address').val() || '—'],
            ['Coordinates', ($('#pickup_lat').val() ? $('#pickup_lat').val() + ', ' + $('#pickup_lng').val() : '—')],
        ]);

        var dCountry = $('#dropoff_country_id option:selected').text().trim() || '—';
        var dCity    = $('#dropoff_city_id option:selected').text().trim() || '—';
        html += reviewSection('bx bx-navigation','Delivery Location', [
            ['Country / City', dCountry + ' / ' + dCity],
            ['Address', $('#dropoff_address').val() || '—'],
            ['Coordinates', ($('#dropoff_lat').val() ? $('#dropoff_lat').val() + ', ' + $('#dropoff_lng').val() : '—')],
        ]);

        html += reviewSection('bx bx-phone','Contacts', [
            ['Loading Contact', ($('#loading_contact_name').val() || '—') + ' — ' + ($('#loading_contact_phone').val() || '—')],
            ['Receiving Contact', ($('#arrival_contact_name').val() || '—') + ' — ' + ($('#arrival_contact_phone').val() || '—')],
        ]);

        html += reviewSection('bx bx-dollar-circle','Pricing', [
            ['Estimated Price', ($('#initial_price').val() ? 'KWD ' + parseFloat($('#initial_price').val()).toFixed(2) : '—')],
        ]);
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res.status === 'success' && res.data) {
                    ...
                    html += '<span class="badge bg-success bg-opacity-20 text-success border border-success border-opacity-40 px-3 py-1.5 rounded-pill font-monospace fs-7"><i class="bx bx-check-shield me-1"></i> Verified Customs Tariff Record</span>';
                    html += '</div>';
                    html += '</div>';
                    ...
                    html += '<div class="col-6 col-md-3"><div class="p-2.5 rounded-3 border" style="background:rgba(255,255,255,0.03);border-color:rgba(255,255,255,0.08)!important;">';
                    ...
                    if (d.restrictions && d.restrictions.length > 0) {
                        html += '<div class="p-3 rounded-3 mb-3" style="background:rgba(245,158,11,0.08);border:1px solid rgba(245,158,11,0.25);">';
                    ...
                    if (d.analysis) {
                        ...
                        html += '<div class="p-3 rounded-3" style="background:rgba(6,182,212,0.06);border:1px solid rgba(6,182,212,0.2);">';
    ...
    // If shipment already has HS Code, perform lookup automatically on load
    if ($('#hs_code').val() && $('#hs_code').val().trim().length >= 3) {
        $('#btnLookupHsCode').click();
    }

    $('#wizardForm').on('submit', function() {
        $('#submitOrderBtn').prop('disabled', true).html('<span class="wz-spinner"></span> Updating...');
    });

...
<div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center mb-4 pb-2 border-bottom border-secondary border-opacity-25 gap-3">
    <div>
        <h3 class="fw-bold mb-1 header-title">
            <i class="bx bx-plus-circle text-info me-2"></i>Add New Truck Brand
        </h3>
        <p class="text-slate-400 mb-0" style="font-size: 0.95rem;">
            Create a vehicle manufacturer brand (e.g. Mercedes-Benz, Volvo, MAN, Scania).
        </p>
    </div>
    <div>
        <a href="{{ route('all.truck.brands') }}" class="btn btn-outline-info rounded-3 px-3 py-2 fw-semibold d-inline-flex align-items-center gap-2">
    ...
    <div class="col-12 col-xl-8">
        <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <div class="card-body p-4">
                <form method="POST" action="{{ route('store.truck.brand') }}">
                    @csrf

                    <div class="row g-3">
                        <!-- Brand Name (English) -->
                        <div class="col-12 col-md-6">
                            <label for="name_en" class="form-label fw-semibold">Brand Name (English) <span class="text-danger">*</span></label>
                        ...
                        <!-- Brand Name (Arabic) -->
                        <div class="col-12 col-md-6">
                            <label for="name_ar" class="form-label fw-semibold">Brand Name (Arabic) <span class="text-danger">*</span></label>
                            <div class="position-relative">
                                <input type="text" 
                                       name="name_ar" 
                                       id="name_ar" 
                    ...
                    <div class="d-flex justify-content-end gap-3 mt-4 pt-3 border-top border-secondary border-opacity-25">
                        <a href="{{ route('all.truck.brands') }}" class="btn btn-outline-secondary px-4 py-2 rounded-3 fw-semibold">
                            Cancel
                        </a>
